...
public class MainActivity extends AppCompatActivity {
    ...
    String urlReceptions = "http://127.0.0.1/hotel_app_backend/controllers/receptionController/get.php";
    String urlCustomers="http://127.0.0.1/hotel_app_backend/controllers/customerController/get.php";
    Gson gson=new Gson();
    String customers;
